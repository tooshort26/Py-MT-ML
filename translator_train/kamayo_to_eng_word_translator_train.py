...
ARCHITECTURE_FILE_PATH = ROOT_DIR + '/translator_train/models/kamayo-to-eng/kamayo-to-eng-word-architecture.json'
...
np.save(ROOT_DIR + '/translator_train/models/kamayo-to-eng/kamayo-to-eng-word-input-word2idx.npy', input_word2idx)
np.save(ROOT_DIR + '/translator_train/models/kamayo-to-eng/kamayo-to-eng-word-input-idx2word.npy', input_idx2word)
np.save(ROOT_DIR + '/translator_train/models/kamayo-to-eng/kamayo-to-eng-word-target-word2idx.npy', target_word2idx)
np.save(ROOT_DIR + '/translator_train/models/kamayo-to-eng/kamayo-to-eng-word-target-idx2word.npy', target_idx2word)
...
np.save(ROOT_DIR + '/translator_train/models/kamayo-to-eng/kamayo-to-eng-word-context.npy', context)
