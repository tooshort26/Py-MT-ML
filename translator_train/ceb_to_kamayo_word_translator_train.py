...
DATA_PATH = ROOT_DIR + '/translator_train/data/ceb-to-kamayo.txt'
WEIGHT_FILE_PATH = ROOT_DIR + '/translator_train/models/ceb-to-kamayo/ceb-to-kamayo-word-weights.h5'
ARCHITECTURE_FILE_PATH = ROOT_DIR + '/translator_train/models/ceb-to-kamayo/ceb-to-kamayo-word-architecture.json'
...
np.save(ROOT_DIR + '/translator_train/models/ceb-to-kamayo/ceb-to-kamayo-word-input-word2idx.npy', input_word2idx)
np.save(ROOT_DIR + '/translator_train/models/ceb-to-kamayo/ceb-to-kamayo-word-input-idx2word.npy', input_idx2word)
np.save(ROOT_DIR + '/translator_train/models/ceb-to-kamayo/ceb-to-kamayo-word-target-word2idx.npy', target_word2idx)
np.save(ROOT_DIR + '/translator_train/models/ceb-to-kamayo/ceb-to-kamayo-word-target-idx2word.npy', target_idx2word)
...
np.save(ROOT_DIR + '/translator_train/models/ceb-to-kamayo/ceb-to-kamayo-word-context.npy', context)
