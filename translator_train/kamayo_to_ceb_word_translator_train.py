...
DATA_PATH = ROOT_DIR + '/translator_train/data/kamayo-to-ceb.txt'
WEIGHT_FILE_PATH = ROOT_DIR + '/translator_train/models/kamayo-to-ceb/kamayo-to-ceb-word-weights.h5'
ARCHITECTURE_FILE_PATH = ROOT_DIR + '/translator_train/models/kamayo-to-ceb/kamayo-to-ceb-word-architecture.json'
...
np.save(ROOT_DIR + '/translator_train/models/kamayo-to-ceb/kamayo-to-ceb-word-input-word2idx.npy', input_word2idx)
np.save(ROOT_DIR + '/translator_train/models/kamayo-to-ceb/kamayo-to-ceb-word-input-idx2word.npy', input_idx2word)
np.save(ROOT_DIR + '/translator_train/models/kamayo-to-ceb/kamayo-to-ceb-word-target-word2idx.npy', target_word2idx)
np.save(ROOT_DIR + '/translator_train/models/kamayo-to-ceb/kamayo-to-ceb-word-target-idx2word.npy', target_idx2word)
...
np.save(ROOT_DIR + '/translator_train/models/kamayo-to-ceb/kamayo-to-ceb-word-context.npy', context)
